...
function MapChild(props: {
	...
	const [naturalValenceFilter, setNaturalValenceFilter] = useState<boolean>(true); // Variabile che indica se mostrare sulla mappa le chiese
	const [hisCultValenceFilter, setHisCultValenceFilter] = useState<boolean>(true); // Variabile che indica se mostrare sulla mappa i monumenti
	const [activityFilter, setActivityFilter] = useState<boolean>(true); // Variabile che indica se mostrare sulla mappa i musei
